...
main = Tk()
main.title('School Management System in Python - Edmund')
main.geometry('1250x700')
main.resizable(0, 0)

# Creating the background and foreground color variables
lf_bg = 'LightBlue' # bg color for the left_frame
...
Label(main, text="SCHOOL MANAGEMENT SYSTEM BY EDMUND", font=headlabelfont, bg='LightBlue').pack(side=TOP, fill=X)
